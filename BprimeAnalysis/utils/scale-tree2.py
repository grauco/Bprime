...
#inDirName = '/shome/thaarres/HiggsTagger/rootfiles/qcd'
#outDirName = '/shome/thaarres/HiggsTagger/rootfiles/scaled'
#inTreeName = 'Fjets'
#histName = "h_multiplicity"
#targetFile = "qcd_forTraining"
#addcmd = "hadd -f %s/%s.root " %(outDirName,targetFile)
#rmcmd = "rm "

inDirName = '/mnt/t3nfs01/data01/shome/grauco/BprimeAna/CMSSW_7_6_3_patch2/src/Bprime/BprimeAnalysis/trees'
outDirName = '/mnt/t3nfs01/data01/shome/grauco/BprimeAna/CMSSW_7_6_3_patch2/src/Bprime/BprimeAnalysis/trees_qcd'
inTreeName = 'ttDMTree'
histName = "h_cutFlow"
targetFile = "qcd"
addcmd = "hadd -f %s/%s.root " %(outDirName,targetFile)
...
for inFileName in os.listdir(inDirName):
  if inFileName.endswith(".root"):
    ...
    if inFileName.find("2000") != -1:
      xSec = 25.24 #25.42 #25.24                                                                                                                    
      genEv = 1961774.0 #events in DAS
    elif inFileName.find("120to170") != -1:
      xSec = 486200.
