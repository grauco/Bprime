...
if opt.channel == 'semileptonic':
    ...
    outhistos = 'output/sl/histos_reMo17'
    outpdfs = 'output/sl/pdfs_reMo17'
    outtxt = 'output/sl/txt_lin_reMo17'
...
if opt.channel == 'singleH':
    ...
    outhistos = 'output/singleh/histos_fwjet'
    outpdfs = 'output/singleh/pdfs_fwjet'
    outtxt = 'output/singleh/txt_fwjet'
...
#                       print "before scaling", htmp.Integral()
                    ...
                    #print nEntries
                    #print c.sigma
                    htmp.Scale((1./nEntries) * c.skimEff * c.sigma * 1000.* float(opt.lumi) )
                    #if (var=="h_htcheck") print htmp.Integral()
...
#                if(c.label.startswith("Bprime")): print '--> Sums after scaling: I(h):', htmp.Integral()
                ...
                if(htmp.Integral()!=0):
                    ...
                    htmp.SetLineWidth(2)
                    if(c.label.startswith("Bprime")): htmp.SetLineWidth(4)
