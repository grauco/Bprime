...
#parser.add_option('-C', '--cat', dest='category', type='string', default = 'cat1', help='category 1, 2, 0')
...
#    store += plots.semileptonic.store
    ...
    outhistos = 'output/singleh/histos_ANv3'
    outpdfs = 'output/singleh/pdfs_ANv3'
    outtxt = 'output/singleh/histos_ANv3'
