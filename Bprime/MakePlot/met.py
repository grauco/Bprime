...
parser.add_option('-d', '--dir', dest='path', type='string', default = 'output/singleh/histos_ANv3/', help='Histos folder')
...
channels = ["cat1_singleH", "cat0_singleH"]

varsFh = {"h_bprimemass_SR":"SRfh", "h_bprimemass_SR":"CRVJetsfh"}#,  "metFinal_outtop":"CR_QCD","metFinal_CR7nw":"CR_ZJets"}
...
def applyMetSys():
    ...
    for s in samples.itervalues():
        for ch in channels:        
            ...
            if(ch =="cat1_singleH" or ch=="cat0_singleH"):
                histos_up = []
                histos_down = []
