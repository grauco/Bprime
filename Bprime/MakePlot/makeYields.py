...
labels = {
    # Region labels
    'SR':r' SR',
    'CR, 1H, 1sj': 'CR, 1H and 1sj',
    'CR, 1aH, 1sj': 'CR, 1aH and 1sj',
    'CR, 1aH, 2sj': 'CR, 1aH and 2sj',
    ...
    #'SL-CR 0b' : 'CR 0b',
    # Sample labels
    'BprimeBToHB1000_v2': r'$M_{B}\;\ 1000\;\mathrm{GeV}$',
    'BprimeBToHB1800_v2': r'$M_{B}\;\ 1800\;\mathrm{GeV}$',
...
if __name__ == '__main__':
    ...
    if opt.channel =='cat0_singleH':
        ...
        yields = {
            'signalRegions': Yields( ['SR'], signal, backgrounds, data, labels=labels ),
            'controlRegions': Yields( ['CR, 1H, 1sj', 'CR, 1aH, 1sj', 'CR, 1aH, 2sj'], signal, backgrounds, data, labels=labels ),
        }
    ...
    for name,y in yields.iteritems():
        ...
        with open(outtables+'/'+name+'_'+opt.channel+'.tex','w') as dottex:
            dottex.write(table)
